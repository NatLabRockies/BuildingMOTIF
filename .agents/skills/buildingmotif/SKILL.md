---
name: buildingmotif
description: Use BuildingMOTIF to validate, repair, and build building and water-system metadata models (Brick/223P/WaTr/SHACL). Covers algebraic repair, templates, application shapes, SCADA and BACnet point lists, ontology exploration, and evidence-grounded model creation. Use when the user mentions BuildingMOTIF, Brick, 223P, WaTr, SHACL, repair proposals or witnesses, point lists, equipment schedules, source documents, or whether a model is sufficient for an application.
---
...
1. Identify the operation: **validate**, **repair**, **build**, or **author requirements**.
...
| Find evidence in point lists, submittals, schedules, BACnet exports, or other local documents | `references/evidence.md` |
...
Keep exploration separate from assertion. Finding an ontology term or a repair that passes
a logical gate does not prove the corresponding equipment, point, connection, or property
...
submittals, schedules, BACnet exports, or source documents. When evidence is absent or
